    ...
    <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Sửa thương hiệu</a></li>
          </ol>
        </nav>
      </div>
<div class="card">
    ...
    <form action="{{ route('brand.update', $brand->id) }}" method="post" enctype="multipart/form-data">
      ...
      <div class="col-md-10">
        ...
        <input type="text" class="form-control @error('name') is-invalid @enderror"
         id="inputName5" name='name' value="{{ old('name') ?? $brand->name }}">
        @error('name')
      ...
      <div class="col-md-12">
        ...
        src="{{ asset('storage/images/brand/' . $brand->image) ?? asset('storage/images/' . $request->inputFile) }}" alt="" />
      </div>
      </div><br>
